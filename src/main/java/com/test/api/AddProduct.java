...
public class AddProduct extends Globals {
    ...
    public void addNewProduct() {
		...
		ConfigurationReader.set("image", faker.internet().image());
		ConfigurationReader.set("category", String.valueOf(faker.number().numberBetween(1, 5)));
        ...
        bodyMap.put("categoryId", Integer.parseInt(ConfigurationReader.get("category")));
        bodyMap.put("images", Collections.singletonList(ConfigurationReader.get("image")));
    ...
    public void addNewProductWithOneMissingField() {
		...
		ConfigurationReader.set("description", faker.commerce().color() + faker.commerce().material());
		ConfigurationReader.set("image", faker.internet().image());
		ConfigurationReader.set("category", faker.number().digit());
